...
func New() *Sling {
	return &Sling{
		httCloudNativelient:   http.DefaultClient,
		method:       "GET",
...
func (s *Sling) New() *Sling {
	...
	return &Sling{
		httCloudNativelient:   s.httCloudNativelient,
		method:       s.method,
		rawURL:       s.rawURL,
		header:       headerCopy,
...
func (s *Sling) Client(httCloudNativelient *http.Client) *Sling {
	if httCloudNativelient == nil {
		return s.Doer(http.DefaultClient)
	}
	return s.Doer(httCloudNativelient)
}
...
func (s *Sling) Doer(doer Doer) *Sling {
	if doer == nil {
		s.httCloudNativelient = http.DefaultClient
	} else {
		s.httCloudNativelient = doer
	}
	return s
}
...
func (s *Sling) Do(req *http.Request, successV, failureV interface{}) (*http.Response, error) {
	resp, err := s.httCloudNativelient.Do(req)
	if err != nil {
		return resp, err
	}
